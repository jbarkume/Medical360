...
const UnscheduledAppointments = () => {
  return (
    <div className=" bg-gray-100 min-h-screen">
      ...
      <Banner goBackPath={"/home"}/>

      <div className="flex justify-between items-center mb-8">
        <h2 className="text-2xl text-gray-700 font-bold">Unscheduled Appointments</h2>
        <div>
          <button className="bg-blue-300 text-white py-2 px-4 rounded-lg mr-2">Upcoming</button>
          <button className="bg-blue-300 text-white py-2 px-4 rounded-lg">Cancelled</button>
        </div>
      </div>

      <div className="grid grid-cols-3 gap-4 mb-8">
        {appointments.map((appointment) => (
          <div key={appointment.id} className="bg-white rounded-lg shadow p-4 flex items-center">
