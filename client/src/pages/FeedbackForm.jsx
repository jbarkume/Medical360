  ...
  return (
    <div className="flex justify-center items-center h-screen bg-gray-100">
      <div className="bg-white p-10 rounded-lg shadow-lg w-full max-w-2xl">
        ...
        <h2 className="text-2xl text-gray-700 font-bold mb-6">Feedback Form</h2>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex justify-between mt-8">
            <button type="button" className="px-4 py-2 rounded text-gray-700 border border-gray-300 shadow-sm hover:bg-gray-100">
              Cancel
            </button>
            <button type="submit" className="px-4 py-2 rounded text-white bg-blue-500 hover:bg-blue-600 shadow-sm">
              SUBMIT
            </button>
          </div>
        </form>
